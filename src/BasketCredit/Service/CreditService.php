...
{
    /** @var EshopModelBasket  */
    private EshopModelBasket $oBasket;
     ...
     * @param EshopModelBasket $oBasket
     * @param string $userId
     * @param float $amount
     */
    public function __construct(EshopModelBasket $oBasket, string $userId, float $amount)
    {
